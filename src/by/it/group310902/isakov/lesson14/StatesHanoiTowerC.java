package by.it.group310902.isakov.lesson14
        ;
import java.util.Scanner;

// Основной класс для решения задачи Ханойской башни с использованием групповых объединений
public class StatesHanoiTowerC {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ringCount; i++) {
            heightSteps[i] = -1; // инициализируем шаги как -1
        }
